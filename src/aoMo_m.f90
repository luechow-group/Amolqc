...
CONTAINS
    ...
    subroutine calc_aomo(ie, x, y, z, rai)
        ...
        real(r8), dimension(:, :), intent(in) :: rai
    ...
    subroutine aomo_calc(ie, x, y, z, rai)
        ...
        real(r8), dimension(:) :: x, y, z    ! x,y,z coordinates of position vector
        real(r8), dimension(:, :) :: rai ! r_ai electron-nucleus distances
    ...
    subroutine aomo1spl_calc(ie, x, y, z, rai)
        ...
        integer :: j, d, moc
        integer :: spl, ispl
        real(r8) :: xx, yy, zz, rr, r2, alp, u, dx, dy, dz, tmp, &
                dx2, dy2, dz2
        real(r8) :: df
        !cc
        real(r8) :: tmps
