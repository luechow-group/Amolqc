...
PRIVATE
PUBLIC :: mt_ran, mt_gran, init_mtran, mt_is_initialized
...
!     ------------------------------
      real(r8) function init_mtran(seed)
!     ------------------------------
...
!     ---------------------
    ...
    function mt_is_initialized() result(bool)
        logical :: bool
        bool = is_initialized
    end function mt_is_initialized
END MODULE mt_m
